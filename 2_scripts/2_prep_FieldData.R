...
# Load data ####
#------------------------------------------
d_popnum <- read.csv("data/1994-2021_Field_PopNum_raw_deposit.csv") # Population numbers
d_trapsnr <- read.csv(file="data/1994-2021_Field_nr-traps_deposit.csv") # Trapping effort
timing <- read.csv("data/1994_2021_Field_timing_deposit.csv") # Seasonal timing
